...
const BANNER_SPECS: Record<BannerFormat, { width: number; height: number; htmlPath: string; envKey: string | undefined }> = {
  // Extensionless paths avoid Cloudflare html_handling 308 (.html → pretty URL),
  // which breaks Adsterra document.write and leaves a blank iframe.
  "728x90": { width: 728, height: 90, htmlPath: "/ads/banner-728x90", envKey: process.env.NEXT_PUBLIC_AD_BANNER_728X90 },
  "300x250": { width: 300, height: 250, htmlPath: "/ads/banner-300x250", envKey: process.env.NEXT_PUBLIC_AD_BANNER_300X250 },
  "468x60": { width: 468, height: 60, htmlPath: "/ads/banner-468x60", envKey: process.env.NEXT_PUBLIC_AD_BANNER_468X60 },
  "160x600": { width: 160, height: 600, htmlPath: "/ads/banner-160x600", envKey: process.env.NEXT_PUBLIC_AD_SIDEBAR_160X600 },
  "160x300": { width: 160, height: 300, htmlPath: "/ads/banner-160x300", envKey: process.env.NEXT_PUBLIC_AD_SIDEBAR_160X300 },
  "320x50": { width: 320, height: 50, htmlPath: "/ads/banner-320x50", envKey: process.env.NEXT_PUBLIC_AD_MOBILE_320X50 },
};
